...
%%%      </ul>
%%%
%%%      <p>To test it, run the {@link wblog} example and put <i>ymnesia</i> in 
%%%      the URL path.</p>
%%% @end
%%%
%%% $Id: ymnesia.erl,v 1.1 2005/11/14 23:09:10 etnt Exp $
%%%-------------------------------------------------------------------
-module(ymnesia).
...
-include("/usr/local/lib/yaws/include/yaws_api.hrl").  %% FIXME !!
